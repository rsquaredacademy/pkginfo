...
```{r app_welcome, echo=FALSE, fig.align='center'}
knitr::include_graphics("inst/images/pkginfo_welcome.png")
```

##### Overview

```{r app_overview, echo=FALSE, fig.align='center'}
knitr::include_graphics("inst/images/pkginfo_overview.png")
```

##### Indicators

```{r app_indicators, echo=FALSE, fig.align='center'}
knitr::include_graphics("inst/images/pkginfo_indicators.png")
```

##### Issues

```{r app_issues, echo=FALSE, fig.align='center'}
knitr::include_graphics("inst/images/pkginfo_issues.png")
```

##### Releases

```{r app_releases, echo=FALSE, fig.align='center'}
knitr::include_graphics("inst/images/pkginfo_releases.png")
```

##### Branches

```{r app_branches, echo=FALSE, fig.align='center'}
knitr::include_graphics("inst/images/pkginfo_branches.png")
```

##### Dependencies

```{r app_deps, echo=FALSE, fig.align='center'}
knitr::include_graphics("inst/images/pkginfo_deps.png")
```

##### Pull Requests

```{r app_prs, echo=FALSE, fig.align='center'}
knitr::include_graphics("inst/images/pkginfo_prs.png")
```

##### Stack Overflow Questions

```{r app_so, echo=FALSE, fig.align='center'}
knitr::include_graphics("inst/images/pkginfo_so.png")
```
